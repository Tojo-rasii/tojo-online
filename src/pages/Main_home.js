...
export class Main_home extends Component {
  render() {
    return (
        <>
      <main className="Main_Accueil bg-light shadow-sm rounded-1 p-4">
...
<legend>
<picture className='svg shadow-sm rounded-1'><svg xmlns="http://www.w3.org/2000/svg" width='32' height='32' fill="#dc3545" className="bi bi-vector-pen" viewBox="0 0 16 16">
