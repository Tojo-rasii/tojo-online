    ...
    return (
      <div className='skills'>
        <main className='skills-main d-flex flex-row gap-4'>
            ...
            <section className='skills-section m-lg-5'>
                 <article className='skills-article'>
                    ...
                    <p className='text-body-secondary fw-semibold mt-4 '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam voluptatibus consequatur dolores eligendi cumque. Dolore harum nihil consectetur minima eius.</p>
