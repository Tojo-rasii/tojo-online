            ...
            <div>
                <main className='Contact d-flex flex-column'>
                    <div className='text-center mt-3'>
                        <p className='h2 fw-bold text-warning'>Besoin d'un design elegant</p>
                    ...
                    <div className='d-flex flex-row flex-wrap justify-content-between mt-4 ms-5 me-5'>
                        <section className='d-flex flex-column gap-1 p-3'>
                            <article>
                                <picture>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#ff0018" className="bi bi-people ms-2 svg shadow-sm rounded-1"  viewBox="0 0 16 16">
                        ...
                        <section className='d-flex flex-column gap-1 p-3'>
                            <article>
                                <picture>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#ff0018" className="bi bi-globe2 ms-1 svg shadow-sm rounded-1" viewBox="0 0 16 16">
